...
public class QuoteController {
    ...
    @GetMapping("/ai-quote")
    @Operation(
        summary = "Get AI generated quote",
        description = "Retrieves an inspirational quote generated by an AI model for a specific topic"
    )
    public ResponseEntity<Quote> getAIQuote(@RequestParam String topic) {
        Quote quote = quoteService.getQuoteFromAI(topic);
        return ResponseEntity.ok(quote);
    }
